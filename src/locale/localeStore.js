// import * as DangerZone from 'expo-localization'
// const { Localization } = DangerZone
// import * as Localization from 'expo-localization';

const localeStore =
  // new Localization.LocaleStore({
  // ru:
  {
    // new
    welcome: "Добро пожаловать, \nЦифровой агент!",
    language: "Выберите язык",
    permissionGeo: "Разрешить геолокацию",
    shareWithFriend: "Поделиться с друзьями",
    insert_iin: {
      text: "Введите Ваш ИИН",
      reason: "Чтобы с Вами связались представители налоговой службы. "
    },
    iin: "ИИН",
    insert_phone: {
      text: "Введите номер телефона",
      reason: "Чтобы с Вами связались представители организации."
    },
    phone_number: "Номер телефона",
    email: "Электронная почта",
    sign_in: {
      with: "Войти через:",
      with_social_network: "Войти через соц. сети"
    },
...
//         permissionGeo: 'Геолокацияға рұқсат ету',
//         welcome: 'Қош келдіңіз! \n',
//         shareWithFriend: 'Достарыңызбен бөлісу',
//         insert_iin: {
//             text: 'ЖСН енгізіңіз',
//             reason: 'Сізбен ұйым өкілдері байланыс жасау үшін. '
//         },
//         iin: 'ЖСН',
//         insert_phone: {
//             text: 'Телефон нөмірін енгізіңіз',
//             reason: 'Сізбен ұйым өкілдері байланыс жасау үшін.'
//         },
//         phone_number: 'Телефон нөмірі',
//         email: 'Электрондық пошта',
//         sign_in: {
//             with: 'Әлеуметтік желілер арқылы кіру:',
//             with_social_network: 'Әлеуметтік желілер арқылы кіру',
//         },
//         signup: 'Тіркелу',
//         password: 'Пароль',
//         rePassword: 'Парольді қайта теріңіз',
//         forgetPassword: 'Парольді ұмыттыңыз ба?',
//         //old
//         search: "Іздеу",
...
//         permissionGeo: 'Allow geolocation',
//         welcome: 'Welcome, \nDigital Agent!',
//         shareWithFriend: 'Share with friends',
//         insert_iin: {
//             text: 'Enter your IIN',
//             reason: 'Чтобы с Вами связались представители налоговой службы. '
//         },
...
//             reason: 'To contact you representatives of the organization.'
//         },
//         phone_number: 'Phone number',
//         email: 'Email',
//         sign_in: {
//             with: 'Login with:',
//             with_social_network: 'Login with social network',
//         },
//         signup: 'Sign up',
//         password: 'Password',
